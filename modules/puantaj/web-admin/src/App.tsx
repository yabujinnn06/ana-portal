...
import { SystemTransitionOverlay } from './components/SystemTransitionOverlay'
...
const DepoPage = lazyPage(() =>
  import('./pages/DepoPage').then((module) => ({ default: module.DepoPage })),
)
...
const OzlukPage = lazyPage(() =>
  import('./pages/OzlukPage').then((module) => ({ default: module.OzlukPage })),
)
const PayrollPage = lazyPage(() =>
  import('./pages/PayrollPage').then((module) => ({ default: module.PayrollPage })),
)
      ...
      <Route element={<AuthGuard />}>
        <Route element={<AppLayout />}>
          ...
          <Route
            path="/communications"
            element={
              <PermissionRoute permission="communications">
          ...
          <Route
            path="/depo"
            element={
              <PermissionRoute permission="depo">
                {renderLazyPage(DepoPage)}
              </PermissionRoute>
            }
          />
        </Route>
