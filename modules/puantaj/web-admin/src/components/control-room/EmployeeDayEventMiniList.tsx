      ...
      <div className="cr-day-event-mini__list">
        {events.length ? (
          events.map((event, index) => {
            ...
            const isEarliest = index === events.length - 1
            return (
              <button
                key={event.id}
                type="button"
              ...
              >
                <div className="cr-day-event-mini__row">
                  ...
                  {isEarliest ? (
                    <span className="cr-day-event-mini__edge is-first">İlk konum</span>
                  ) : isLatest ? (
                    <span className="cr-day-event-mini__edge is-last">Son konum</span>
                  ) : null}
