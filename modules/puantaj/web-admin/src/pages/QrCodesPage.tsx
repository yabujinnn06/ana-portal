...
import { renderBrandedQrDataUrl } from '../lib/brandedQr'
...
export function QrCodesPage() {
  ...
  useEffect(() => {
    ...
    try {
      setSelectedCodeQrDataUrl(renderBrandedQrDataUrl(selectedCode.code_value, 420))
    } catch {
      setSelectedCodeQrDataUrl(null)
    }
  ...
  const downloadQrPng = (code: QrCode) => {
    try {
      const dataUrl = renderBrandedQrDataUrl(code.code_value, 1024)
      if (!dataUrl) {
