...
function toDatetimeLocalValue(ts: string): string {
  // Render in the attendance timezone, not the browser's, so the edit form
  // matches the table and round-trips via ts_local without shifting the instant.
